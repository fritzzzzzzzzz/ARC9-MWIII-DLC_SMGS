...
SWEP.Description = ARC9:GetPhrase("")
	or [[Compact by design, this fully automatic weapon has a high rate of fire and low recoil.]]
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "reload_maggrab.ogg", t = 14 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_magout_01.ogg", t = 16 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_magbump_01.ogg", t = 28 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_magin_01.ogg", t = 34 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_mvmt_02.ogg", t = 42 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_hand_01.ogg", t = 50 / 30 },
		},
	},
	["reload_empty"] = {
		Source = "reload_empty",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_mvmt_01.ogg", t = 0 / 30 },
			{ s = path .. "reload_maggrab.ogg", t = 6 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_magout_01.ogg", t = 7 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_magbump_01.ogg", t = 38 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_magin_01.ogg", t = 41 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_charge_01.ogg", t = 56 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_mvmt_02.ogg", t = 70 / 30 },
			{ s = path .. "reload_empty_hand.ogg", t = 74 / 30 },
		},
	},
	["reload_fast"] = {
		Source = "reload_fast",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_fast_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_magout_01.ogg", t = 7 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_magbump_01.ogg", t = 23 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_magin_01.ogg", t = 28 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_mvmt_02.ogg", t = 40 / 30 },
			{ s = path .. "reload_fast_hand.ogg", t = 41 / 30 },
		},
	},
	["reload_fast_empty"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_fast_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_magout_01.ogg", t = 5 / 30 },
			{ s = path .. "reload_empty_fast_maghit.ogg", t = 22 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_magin_01.ogg", t = 26 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_hand_01.ogg", t = 39 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_charge_01.ogg", t = 40 / 30 },
			{ s = path .. "reload_empty_fast_end.ogg", t = 49 / 30 },
		},
	},
	["reload_xmag"] = {
		Source = "reload_xmag",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_xmag_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "reload_xmag_maggrab.ogg", t = 6 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_xmag_magout_01.ogg", t = 13 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_xmag_magbump_01.ogg", t = 31 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_xmag_magin_01.ogg", t = 40 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_xmag_mvmt_02.ogg", t = 58 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_xmag_hand_01.ogg", t = 62 / 30 },
		},
	},
	["reload_xmag_empty"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "reload_xmag_maggrab.ogg", t = 6 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_magout_01.ogg", t = 6 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_magbump_01.ogg", t = 41 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_magin_01.ogg", t = 47 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_charge_01.ogg", t = 68 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_mvmt_02.ogg", t = 79 / 30 },
			{ s = path .. "reload_empty_xmag_hand.ogg", t = 85 / 30 },
		},
	},
	["reload_xmag_fast"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_fast_xmag_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_xmag_magout_01.ogg", t = 5 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_magbump_01.ogg", t = 26 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_xmag_magin_01.ogg", t = 30 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_xmag_mvmt_02.ogg", t = 51 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_hand_01.ogg", t = 52 / 30 },
		},
	},
	["reload_xmag_fast_empty"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_xmag_magout_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_xmag_mvmt_01.ogg", t = 5 / 30 },
			{ s = path .. "reload_empty_fast_xmag_maghit.ogg", t = 26 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_xmag_magin_01.ogg", t = 30 / 30 },
			{ s = path .. "reload_empty_fast_xmag_hand.ogg", t = 50 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_xmag_charge_01.ogg", t = 53 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_xmag_mvmt_02.ogg", t = 60 / 30 },
		},
	},
	["reload_smag"] = {
		Source = "reload_smag",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_smag_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "reload_smag_maggrab.ogg", t = 14 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_smag_magout_01.ogg", t = 15 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_magbump_01.ogg", t = 28 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_smag_magin_01.ogg", t = 30 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_smag_mvmt_02.ogg", t = 41 / 30 },
			{ s = path .. "reload_smag_hand.ogg", t = 43 / 30 },
		},
	},
	["reload_smag_empty"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_empty_smag_mvmt_01.ogg", t = 0 / 30 },
			{ s = path .. "reload_smag_maggrab.ogg", t = 6 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_smag_magout_01.ogg", t = 6 / 30 },
			{ s = path .. "reload_empty_smag_maghit.ogg", t = 29 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_smag_magin_01.ogg", t = 31 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_smag_charge_01.ogg", t = 48 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_smag_mvmt_02.ogg", t = 61 / 30 },
			{ s = path .. "reload_smag_hand.ogg", t = 62 / 30 },
		},
	},
	["reload_smag_fast"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_fast_smag_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_smag_magout_01.ogg", t = 7 / 30 },
			{ s = path .. "reload_fast_smag_maghit.ogg", t = 22 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_smag_magin_01.ogg", t = 24 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_fast_smag_mvmt_02.ogg", t = 33 / 30 },
			{ s = path .. "reload_fast_smag_hand.ogg", t = 35 / 30 },
		},
	},
	["reload_smag_fast_empty"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_fast_smag_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_smag_magout_01.ogg", t = 6 / 30 },
			{ s = path .. "reload_empty_fast_smag_maghit.ogg", t = 22 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_smag_magin_01.ogg", t = 23 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_smag_hand_02.ogg", t = 34 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_smag_charge_01.ogg", t = 36 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_smag_mvmt_02.ogg", t = 46 / 30 },
		},
	},
	["ready"] = {
		Source = "draw",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_raise_first_mvmt_01.ogg", t = 2 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_fast_hand_01.ogg", t = 8 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_smag_magin_01.ogg", t = 19 / 30 },
			{ s = path .. "p32_pi_mpapa9_raise_first_mvmt_02.ogg", t = 30 / 30 },
		},
	},
	["ready_nostock"] = {
		Source = "draw_nostock",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_reload_hand_01.ogg", t = 2 / 30 },
			{ s = path .. "p32_pi_mpapa9_reload_empty_xmag_charge_01.ogg", t = 11 / 30 },
			{ s = path .. "p32_pi_mpapa9_raise_first_mvmt_01.ogg", t = 26 / 30 },
			{ s = path .. "p32_pi_mpapa9_raise_first_mvmt_02.ogg", t = 28 / 30 },
		},
	},
	["draw"] = {
		Source = "draw_short",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_raise_mvmt_01.ogg", t = 1 / 30 },
		},
	},
	["holster"] = {
		Source = "holster",
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_drop_mvmt_01.ogg", t = 0 / 30 },
		},
	},
	["idle"] = {
		Source = "idle",
	...
	["inspect"] = {
		...
		EventTable = {
			{ s = path .. "p32_pi_mpapa9_inspect_mvmt_01.ogg", t = 1 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_mvmt_02.ogg", t = 49 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_maghand_01.ogg", t = 53 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_magout_01.ogg", t = 59 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_mvmt_03.ogg", t = 94 / 30 },
			{ s = path .. "boltgrab.ogg", t = 116 / 30 },
			{ s = path .. "boltback.ogg", t = 123 / 30 },
			{ s = path .. "boltforward.ogg", t = 140 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_mvmt_04.ogg", t = 148 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_magbump_01.ogg", t = 173 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_magin_01.ogg", t = 178 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_mvmt_05.ogg", t = 188 / 30 },
			{ s = path .. "p32_pi_mpapa9_inspect_hand_01.ogg", t = 192 / 30 },
		},
	},
	["inspect_smag"] = {
