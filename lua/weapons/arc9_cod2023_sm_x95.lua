...
SWEP.Description = ARC9:GetPhrase("")
	or [[More maneuverable and agile than its assault rifle counterpart, this bullpup SMG chambered in 9mm is lethal at close range.]]
...
SWEP.DropMagazineModel = "models/weapons/cod2023/mags/x95_mag32_world.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		EventTable = {
			...
			{ s = path .. "p25_sm_talpha95m_reload_empty_fast_xmag_magout.ogg", t = 0.8 },
			{ s = path .. "p25_sm_talpha95m_reload_maghit.ogg", t = 1.167 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_maghit2.ogg", t = 1.333 },
			{ s = path .. "p25_sm_talpha95m_reload_magin.ogg", t = 1.433 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_smag_magin.ogg", t = 1.466 },
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "p25_sm_talpha95m_reload_empty_fast_xmag_magout.ogg", t = 0.433 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_arm.ogg", t = 1.1 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_maghit.ogg", t = 1.403 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_maghit2.ogg", t = 1.437 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_magin.ogg", t = 1.7 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_rotatemvmnt.ogg", t = 1.9 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_rotate.ogg", t = 2.0 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_charge.ogg", t = 2.3 },
	...
	["reload_fast"] = {
		...
		EventTable = {
			...
			{ s = path .. "p25_sm_talpha95m_reload_fast_smag_magout.ogg", t = 0.173 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit.ogg", t = 0.95 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit2.ogg", t = 1.05 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_magin.ogg", t = 1.21 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_smag_magin.ogg", t = 1.26 },
			{ s = path .. "wfoly_ar_tango21_reload_fast_end.ogg", t = 1.537 },
		},
	},
	["reload_fast_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "p25_sm_talpha95m_magout_03.ogg", t = 0.167 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_fast_xmag_maghit.ogg", t = 0.96 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit2.ogg", t = 1.02 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_magin.ogg", t = 1.23 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_fast_bolt_forward.ogg", t = 1.42 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_fast_end.ogg", t = 1.8 },
		},
	},
	["reload_xmag"] = {
		Source = "reload_xmag",
		...
		EventTable = {
			{ s = path .. "wfoly_ar_tango21_reload_fast_up.ogg", t = 0.0 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_smag_magout.ogg", t = 0.4 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit.ogg", t = 0.85 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit2.ogg", t = 0.95 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_magin.ogg", t = 1.15 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_smag_magin.ogg", t = 1.19 },
	...
	["reload_xmag_fast"] = {
		...
		EventTable = {
			...
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit.ogg", t = 0.95 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit2.ogg", t = 1.05 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_magin.ogg", t = 1.16 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_smag_magin.ogg", t = 1.2 },
			{ s = path .. "wfoly_ar_tango21_reload_fast_end.ogg", t = 1.537 },
		},
	},
	["reload_xmag_fast_empty"] = {
		...
		EventTable = {
			{ s = path .. "wfoly_ar_tango21_reload_empty_fast_up.ogg", t = 0.0 },
			{ s = path .. "p25_sm_talpha95m_magout_03.ogg", t = 0.167 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_fast_xmag_maghit.ogg", t = 1 },
			{ s = path .. "p25_sm_talpha95m_reload_fast_maghit2.ogg", t = 1.06 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_magin.ogg", t = 1.27 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_fast_bolt_forward.ogg", t = 1.42 },
	...
	["reload_drum"] = {
		...
		EventTable = {
			...
			{ s = path .. "wfoly_ar_tango21_reload_drum_magout.ogg", t = 15 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_maghitwell.ogg", t = 36 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_magin.ogg", t = 49 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_fast_magin.ogg", t = 57 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_end.ogg", t = 64 / 30 },
		},
	},
	["reload_drum_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "wfoly_ar_tango21_reload_empty_rotatemvmnt.ogg", t = 23 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_arm.ogg", t = 28 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_maghitwell.ogg", t = 38 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_magin.ogg", t = 48 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_rotate.ogg", t = 56 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_charge.ogg", t = 69 / 30 },
	...
	["reload_drum_fast"] = {
		...
		EventTable = {
			...
			{ s = path .. "wfoly_ar_tango21_reload_drum_fast_maghitwell.ogg", t = 27 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_fast_magin.ogg", t = 37 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_fast_end.ogg", t = 45 / 30 },
		},
	},
	["reload_drum_fast_empty"] = {
		...
		EventTable = {
			...
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_fast_maghit.ogg", t = 27 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_fast_magin.ogg", t = 37 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_fast_end.ogg", t = 56 / 30 },
		},
	},
	["ready"] = {
		Source = "draw",
	...
	["inspect"] = {
		...
		EventTable = {
			...
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_magout.ogg", t = 0.545 },
			{ s = path .. "p25_sm_talpha95m_magout_03.ogg", t = 0.633 },
			{ s = path .. "wfoly_ar_tango21_inspect_02.ogg", t = 1.433 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_fast_xmag_maghit.ogg", t = 1.830 },
			{ s = path .. "p25_sm_talpha95m_reload_empty_xmag_maghit2.ogg", t = 1.843 },
			{ s = path .. "p25_sm_talpha95m_reload_magin.ogg", t = 2.363 },
			{ s = path .. "wfoly_ar_tango21_inspect_03.ogg", t = 2.533 },
			{ s = path .. "inspect_boltback.ogg", t = 3.1 },
			{ s = path .. "inspect_boltforward.ogg", t = 3.7 },
			{ s = path .. "wfoly_ar_tango21_inspect_04.ogg", t = 3.4 },
			{ s = path .. "wfoly_ar_tango21_inspect_05.ogg", t = 3.9 },
		},
	},
	["inspect_drum"] = {
		...
		EventTable = {
			{ s = path .. "wfoly_ar_tango21_reload_drum_fast_up.ogg", t = 0 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_up.ogg", t = 43 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_empty_maghitwell.ogg", t = 55 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_maghandhit.ogg", t = 68 / 30 },
			{ s = path .. "inspect_boltback.ogg", t = 93 / 30 },
			{ s = path .. "inspect_boltforward.ogg", t = 112 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_empty_rotatemvmnt.ogg", t = 115 / 30 },
			{ s = path .. "wfoly_ar_tango21_reload_drum_fast_end.ogg", t = 123 / 30 },
		},
	},
	["bash"] = {
...
SWEP.Hook_ModifyBodygroups = function(wep, data)
	...
	if wep:HasElement("optic_scope") then
