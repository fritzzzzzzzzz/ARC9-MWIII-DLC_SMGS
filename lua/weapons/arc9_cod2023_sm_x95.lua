	...
	["inspect_drum"] = {
        ...
        EventTable = {
		    ...
		    {s = path .. "wfoly_ar_tango21_reload_drum_empty_up.ogg", t = 43/30},
		  	{s = path .. "wfoly_ar_tango21_reload_drum_empty_maghitwell.ogg", t = 59/30},
			{s = path .. "wfoly_ar_tango21_reload_drum_maghandhit.ogg", t = 71/30},
			{s = path .. "inspect_boltback.wav", t = 93/30},
			{s = path .. "inspect_boltforward.wav", t = 112/30},
